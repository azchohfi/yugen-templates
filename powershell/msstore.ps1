...
.\powershell\msstore.ps1 "build" -AppName "YugenApps"
.\powershell\msstore.ps1 "publishrollout" -AppName "YugenApps"
#>
...
switch ($Arg) {   
    ...
    }
    {
        ...
        # NOTE: --noCommit does not work with ----packageRolloutPercentage
